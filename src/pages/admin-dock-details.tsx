...
import { DockingSpotData } from "../types/docking-spot.ts";
...
export default function DockingSpotDetails() {
  ...
  const { isLoading, formData, isEditing, showModal, setShowModal,
    setIsEditing, handleChange, handleSave, handleDelete } = useDockingSpotDetails(dockId!);
